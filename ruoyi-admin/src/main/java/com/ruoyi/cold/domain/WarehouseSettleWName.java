 ...
 * @date 2025-05-15
 */
public class WarehouseSettleWName extends BaseEntity
{
    ...
    @Excel(name = "客户姓名")
    private String warehouseSettleClientName;
    ...
    public String getWarehouseSettleClientName(){return warehouseSettleClientName;}

    public void setWarehouseSettleClientName(String warehouseSettleClientName){this.warehouseSettleClientName = warehouseSettleClientName;}
